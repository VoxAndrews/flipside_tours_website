    ...
    <section class="container-fluid index-section-one-bg">
        ...
        <section class="container content-width">
            <div class="row">
                ...
                <div class="col-sm-6 remove-padding">
                    <img class="index-tour-img" src="http://206.189.45.97/~mesh22/sub4/wp-content/themes/flipside_tours_website/images/content/index/index-tour-img-1.png" alt="Photo of the Whalers Tunnel in Fremantle">
                </div>
            </div>
        </section>
        ...
        <section class="container content-width">
            <div class="row">
                ...
                <div class="col-sm-6 remove-padding">
                    <img class="index-tour-img" src="http://206.189.45.97/~mesh22/sub4/wp-content/themes/flipside_tours_website/images/content/index/index-tour-img-2.png" alt="Photo of the Spice Market in Fremantle">
                </div>
            </div>
        </section>
    </section>
        ...
        <section class="container index-content-one remove-padding content-width">
            <div class="row">
                ...
                <div class="col-sm-8 remove-padding" style="text-align: right">
                    <img class="index-blog-img" src="http://206.189.45.97/~mesh22/sub4/wp-content/themes/flipside_tours_website/images/content/index/index-blog-img-1.jpg" alt="Photo of the Entrance to the Fremantle Prison">
                </div>
            </div>
        </section>
    </section>
